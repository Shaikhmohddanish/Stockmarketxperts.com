      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="max-w-4xl mx-auto space-y-8 text-gray-300">
          ...
          <section>
            ...
            <p>
              Our website may contain links to third-party services. We are not responsible for the privacy practices of
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-white">10. Changes to Privacy Policy</h2>
            <p>
